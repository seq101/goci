...
public class JsonExporterApp {
        ...
        try {
            ...
            if (cl.hasOption("")) {
                ...
                if(cl.hasOption("i")){
                    ...
                    System.err.println("-i (variant to gene mapping file) argument is required");
                    help.printHelp("publish", options, true);
                    parseArgs += 3;
                }
            }
    ...
    private static Options bindOptions() {
        ...
        Option outputFileOption = new Option("o", "output", true,
                                             "The output file to write the variant variantIds to");
    ...
    public void getAndSave(String outputFilePath, String inputFilePath) throws IOException {
        ...
        //        File file = new File("/Users/catherineleroy/Documents/github_project/goci/goci-tools/goci-cttv-export/target/variant.txt");
