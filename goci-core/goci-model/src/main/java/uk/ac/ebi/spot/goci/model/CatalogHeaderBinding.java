...
public enum CatalogHeaderBinding {
    ...
    ENTREZ_MAPPED_GENE("ENTREZ_MAPPED_GENE",
                       ...
                       new Inclusion.FieldIncluded("variant_gene_symbols")),
    ...
    ENTREZ_MAPPED_GENE_ID("ENTREZ_MAPPED_GENE_ID",
                          new Inclusion.Excluded(),
                          new Inclusion.CommaSeparatedIncluded("VARIANT_GENE_IDS_ENTREZ"),
                          new Inclusion.FieldIncluded("variant_gene_ids")),
    ENSEMBL_MAPPED_GENE_ID("ENSEMBL_MAPPED_GENE_ID",
                           new Inclusion.Excluded(),
                           new Inclusion.CommaSeparatedIncluded("VARIANT_GENE_IDS_ENSEMBL"),
                           new Inclusion.Excluded()),
    ...
    DOWNLOAD_ENSEMBL_DOWNSTREAM_GENE_DISTANCE(new Inclusion.Excluded(),
                                              ...
                                              new Inclusion.Excluded()),
    STRONGEST_VARIANT_EFFECT_ALLELE("STRONGEST_VARIANT_EFFECT_ALLELE",
                              new Inclusion.CommaSeparatedIncluded("STRONGEST VARIANT-EFFECT ALLELE"),
                              new Inclusion.UniqueIncluded("STRONGEST VARIANT-EFFECT ALLELE"),
                              new Inclusion.Excluded()),
    VARIANT_EXTERNALID("VARIANT_EXTERNALID",
             new Inclusion.FieldIncluded("VARIANTS"),
             new Inclusion.UniqueIncluded("VARIANTS"),
             new Inclusion.Excluded()),
    VARIANT_EXTERNALID_FOR_ID("VARIANT_EXTERNALID", new Inclusion.Excluded(), new Inclusion.Extracted(), new Inclusion.Excluded()),
    DOWNLOAD_VARIANT_ID(new Inclusion.Excluded(),
                    new Inclusion.FieldIncluded("VARIANT_ID_CURRENT"),
                    new Inclusion.Excluded()),
    MERGED("MERGED",
           new Inclusion.Excluded(),
           new Inclusion.FieldIncluded("MERGED"),
           new Inclusion.FieldIncluded("merged")),
    VARIANT_ID("VARIANT_ID", new Inclusion.UniqueExtracted(), new Inclusion.Excluded(), new Inclusion.FieldIncluded("variant_id")),
    ...
    IS_INTERGENIC_ENSEMBL("IS_INTERGENIC_ENSEMBL",
                          ...
                          new Inclusion.Excluded()),
    EFFECT_ALLELE_FREQUENCY("VARIANT_ALLELE_FREQUENCY",
                          new Inclusion.FieldIncluded("EFFECT ALLELE FREQUENCY"),
                          new Inclusion.UniqueIncluded("EFFECT ALLELE FREQUENCY"),
                          new Inclusion.Excluded()),
    ...
    SPREADSHEET_CI(new Inclusion.FieldIncluded("95% CI (TEXT)"),
                   ...
                   new Inclusion.Excluded()),
    PLATFORM("PLATFORM",
             new Inclusion.FieldIncluded("PLATFORM [VARIANTS PASSING QC]"),
             new Inclusion.FieldIncluded("PLATFORM [VARIANTS PASSING QC]"),
             new Inclusion.Excluded()),
    ...
    ASSOCIATION_ID("ASSOCIATION_ID",
                   new Inclusion.UniqueIncluded("GWASTUDIESVARIANTID"),
                   new Inclusion.Excluded(),
                   new Inclusion.FieldIncluded("studies_variant_id")),
    STUDY_ID("STUDY_ID",
    ...
    VARIANT_ERROR("VARIANT_ERROR",
              new Inclusion.Excluded(),
              new Inclusion.Excluded(),
              new Inclusion.FieldIncluded("variant_id_error")),
    GENE_ERROR("GENE_ERROR",
               new Inclusion.Excluded(),
               new Inclusion.Excluded(),
               new Inclusion.FieldIncluded("gene_error")),
    VARIANT_GENE_ON_DIFF_CHR("VARIANT_GENE_ON_DIFF_CHR",
                         new Inclusion.Excluded(),
                         new Inclusion.Excluded(),
                         new Inclusion.FieldIncluded("variant_gene_on_diff_chr")),
