...
public class SparqlQueries {
    ...
    public static final String BAND_FOR_ASSOCIATION =
            "SELECT ?band " +
                    "WHERE { ?association a gt:TraitAssociation ; oban:has_subject ?variant . " +
                    "?variant ro:located_in ?band . " +
                    "FILTER (?association = ??) }";
    ...
    public static final String ASSOCIATIONS_IN_BAND_PVALUE_FILTER =
            "SELECT ?association " +
                    "WHERE { ?association a gt:TraitAssociation ; oban:has_subject ?variant ; gt:has_p_value ?pvalue . " +
                    "?variant ro:located_in ?band . " +
                    "FILTER (?band = ??) " +
                    "FILTER (?pvalue < ??) " +
                    "FILTER (?pvalue >= ??) }";
    public static final String ASSOCIATIONS_IN_BAND_DATE_FILTER =
            "SELECT ?association " +
                    "WHERE { ?association a gt:TraitAssociation ; oban:has_subject ?variant ; ro:part_of ?study . " +
                    "?variant ro:located_in ?band . " +
    ...
    public static final String ASSOCIATIONS_IN_BAND_PVALUE_DATE_FILTER =
            "SELECT ?association " +
                    "WHERE { ?association a gt:TraitAssociation ; oban:has_subject ?variant ; gt:has_p_value ?pvalue ; ro:part_of ?study . " +
                    "?variant ro:located_in ?band . " +
                    "?study gt:has_publication_date ?date . " +
                    "FILTER (?band = ??) " +
                    "FILTER (?pvalue < ??) " +
    ...
    public static final String TRAITS_IN_BAND =
            "SELECT ?trait ?band " +
                    "WHERE { ?association a gt:TraitAssociation ; oban:has_subject ?variant ; oban:has_object ?trait . " +
                    "?variant ro:located_in ?band ; " +
                    "FILTER (?band = ??) }";
    public static final String TRAITS_IN_BAND_PVALUE_FILTER =
            "SELECT ?trait ?band " +
                    "WHERE { ?association a gt:TraitAssociation ; oban:has_subject ?variant ; oban:has_object ?trait ; gt:has_p_value ?pvalue . " +
                    "?variant ro:located_in ?band ; " +
                    "FILTER (?band = ??)" +
                    "FILTER (?pvalue < ??) " +
                    "FILTER (?pvalue >= ??) }";
    public static final String TRAITS_IN_BAND_DATE_FILTER =
            "SELECT ?trait ?band " +
                    "WHERE { ?association a gt:TraitAssociation ; oban:has_subject ?variant ; oban:has_object ?trait ; ro:part_of ?study . " +
                    "?variant ro:located_in ?band . " +
                    "?study gt:has_publication_date ?date . " +
                    "FILTER (?band = ??)" +
                    "FILTER (?date < ??) " +
    ...
    public static final String TRAITS_IN_BAND_PVALUE_DATE_FILTER =
            "SELECT ?trait ?band " +
                    "WHERE { ?association a gt:TraitAssociation ; oban:has_subject ?variant ; oban:has_object ?trait ; gt:has_p_value ?pvalue ; ro:part_of ?study . " +
                    "?variant ro:located_in ?band . " +
                    "?study gt:has_publication_date ?date . " +
                    "FILTER (?band = ??)" +
                    "FILTER (?pvalue < ??) " +
    ...
    public static final String DATE_OF_TRAIT_ID_FOR_BAND =
            "SELECT DISTINCT ?trait (min(?date) as ?first) " +
                    "WHERE { " +
                    "?association a gt:TraitAssociation ; oban:has_subject ?variant ; oban:has_object ?trait ; ro:part_of ?study . " +
                    "?study gt:has_publication_date ?date . " +
                    "?variant ro:located_in ?band . " +
                    "FILTER ( ?band = ?? ) } " +
                    "GROUP BY ?trait " +
    ...
    public static final String DATE_OF_TRAIT_ID_FOR_BAND_PVALUE_FILTER =
            "SELECT DISTINCT ?trait (min(?date) as ?first) " +
                    "WHERE { " +
                    "?association a gt:TraitAssociation ; oban:has_subject ?variant ; oban:has_object ?trait ; ro:part_of ?study ; gt:has_p_value ?pvalue. " +
                    "?study gt:has_publication_date ?date . " +
                    "?variant ro:located_in ?band . " +
                    "FILTER ( ?band = ?? ) " +
                    "FILTER (?pvalue < ??) " +
